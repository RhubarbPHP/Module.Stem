...
/**
 * Wraps a cursor to provide range support.
 */
class RangeLimitedCursor extends CollectionCursor
{
    private $baseCursor;
    ...
    public function __construct(CollectionCursor $baseCursor, $rangeStart = 0, $rangeEnd = false)
    {
    ...
    {
        $this->baseCursor->filterModelsByIdentifier($uniqueIdentifiersToFilter);
    }
